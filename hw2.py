...
list1 = [str(random.randrange(-n, n)) for i in range(0, n)] # реализовали список, заполнив его случайными числами из
# промежутка [-n, n]
list1 = [int(num) for num in list1] # чтобы с ним работать, преобразовали в тип int из типа str
